...
const GENERATION_CONTRACT_VERSION = "v1";
...
function parseNullableString(value, maxLength) {
...
function parseGenerationContract(input) {
...
function formatGenerationContractPromptLines(contract) {
  if (!contract) return [];
  return [
    "GenerationContract:",
