...
- **Comfly 代理接口**：新增 comfly 代理配置，可按需将 Veo（/v2/videos/generations）、Sora2（/v1/videos）、Nano Banana（Gemini /v1beta/models/...:generateContent）与 Hailuo（MiniMax /minimax/v1/...）走代理接口调用。
